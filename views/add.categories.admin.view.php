        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"><?= SHOP_CATEGORY_ADD_MAIN_TITLE ?></h3>
                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="category_name"> <?= SHOP_ITEM_NAME ?>*</label>
                                        <input name="category_name" id="category_name" type="text"
                                               class="form-control form-control-border border-width-2"
                                               placeholder="<?= SHOP_CATEGORY_PLACEHOLDER_NAME ?>">
                                    </div>
                                </div>

                                <div class="col-12">
                                    <label for="category_name"> <?= SHOP_ITEM_DESCRIPTION ?></label>
